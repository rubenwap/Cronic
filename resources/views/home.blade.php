...
<a href="{{ url('/articles/create') }}"><button type="button" class="btn btn-primary additions">  <span class="glyphicon glyphicon-plus" title="Add Entry" aria-hidden="true"></span>
 </button></a>
